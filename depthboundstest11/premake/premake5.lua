_AMD_SAMPLE_NAME = "DepthBoundsTest11"
...
project (_AMD_SAMPLE_NAME)
   ...
   includedirs { "../src/ResourceFiles", "../../ags_lib/inc" }
   libdirs { "../../ags_lib/lib" }
   links { "amd_ags_x64", "AMD_SDK_Minimal", "DXUT", "DXUTOpt", "d3dcompiler", "dxguid", "winmm", "comctl32", "Usp10", "Shlwapi" }
